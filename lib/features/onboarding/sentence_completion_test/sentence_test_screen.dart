...
class SentenceCompletionTestScreen extends StatefulWidget {
  ...
  @override
  State<SentenceCompletionTestScreen> createState() =>
      _SentenceCompletionTestScreenState();
}

class _SentenceCompletionTestScreenState
    extends State<SentenceCompletionTestScreen> {
  late SentenceTestService _service;
  late List<SentenceCompletionQuestion> _questions;
  ...
  void _handleNext() {
    ...
    // Record result
    widget.assessmentController.addSentenceResult(
